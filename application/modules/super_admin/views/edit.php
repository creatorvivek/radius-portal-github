...
<div class="row ">
  ...
  <div class="col-md-5">
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <?= form_open_multipart('super_admin/update/'.$frenchise[0]['f_id'],array("class"=>"form-horizontal form_validation")) ?>
        <div class="row"> 
        <div class="col-md-5">
        ...
        <div class="col-md-5">
          ...
          <div class="form-group">
            <input type="text" name="mobile" readonly  maxlength=10  class="form-control" id="mobile" onkeypress="return isNumberKey(event)" onfocusout="validateMobile()" value="<?= ($this->input->post('mobile') ? $this->input->post('mobile') : $frenchise[0]['mobile']); ?>"  />
