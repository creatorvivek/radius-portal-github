        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <nav class="mt-2">
                ...
                data-accordion="false">
                    ...
                    <!--  <li class="nav-item has-treeview menu-open">
                       ...
                       <ul class="nav nav-treeview"> -->
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url() ?>super_admin/dashboard" class="nav-link">
                ...
                <li class="nav-item has-treeview <?php if($this->uri->segment(1)=="frenchise"){ ?> menu-open <?php } ?> ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                        <a href="<?= site_url() ?>super_admin/add_frenchise" class="nav-link">
                            <i class="fa fa-sign-out nav-icon"></i>
                            <p>ADD FRENCHISE</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= site_url() ?>super_admin/list_frenchise" class="nav-link">
                            <i class="fa fa-sign-out nav-icon"></i>
                            <p>FRENCHISE LIST</p>
                        </a>
                    </li>
                   <!--  <li class="nav-item">
                        <a href="<?= site_url() ?>super_admin/frenchise_tree_view" class="nav-link">
                            <i class="fa fa-sign-out nav-icon"></i>
                            <p>FRENCHISE TREE</p>
                        </a>
                    </li> -->
      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url()?>super_admin/dashboard">Home</a></li>
