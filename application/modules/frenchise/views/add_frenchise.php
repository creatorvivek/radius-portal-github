...
<div class="row ">
  ...
  <div class="col-md-5">
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <?= form_open('frenchise/add',array("class"=>"form-horizontal form_validation")) ?>
        <div class="row"> 
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <span class="text-danger f_name_error"><?= form_error('f_name');?></span>
          </div>
        </div>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <input type="text" name="mobile" value="<?php echo $this->input->post("mobile"); ?>" maxlength=10   class="form-control" id="mobile" required autocomplete="off" onkeypress="return isNumberKey(event)" onkeyup="validateMobile()"  />
            <span class="text-danger col-md-12 mobile_error"><?= form_error('mobile');?></span>
          </div>
        </div>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <input type="text" name="email" value="<?php echo $this->input->post("email"); ?>" class="form-control" id="email" required data-parsley-type="email" data-parsley-trigger="keyup"  />
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <span class="text-danger nas_error"><?= form_error('address');?></span>
          </div>
        </div>
       <!--  <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <span class="text-danger nas_error"><?= form_error('f_type');?></span>
        </div>
        <div id="revenue_persent"  class="col-md-6" style="display:none;">
          <label for="task" class="col-md-12 control-label"><span class="text-danger">*</span>Parent Revenue %</label>
          <div class="form-group">
          <input type="text" name="r_percent" class="form-control" data-toggle="tooltip" title="parent frenchise Revenue percentage" onkeypress="return isNumberKey(event)">
        </div>
        </div>
        <br>
  <div class="col-sm-offset-4 col-sm-6 col-md-12" align="center">
<div class="form-group">
    <button type="submit" class="btn btn-success save-button" onclick="formValidation()">Save</button>
  </div>
</div>
        </div>
