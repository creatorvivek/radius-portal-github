                ...
                <div class="pricingTable">
                    <div class="pricingTable-header">
                        <div class="price-value">
                            <span class="amount">$10</span><span class="month">/month</span>
                        </div>
                    </div>
                    <div class="pricing-content">
                        <div class="content">
                            ...
                            <ul>
                                <li><i class="fa fa-square"></i> 50GB Disk Space</li>
                                <li><i class="fa fa-square"></i> 50 Email Accounts</li>
                                <li class="disable"><i class="fa fa-square"></i> 50GB Bandwidth</li>
                                <li class="disable"><i class="fa fa-square"></i> 10 Subdomains</li>
                                <li class="disable"><i class="fa fa-square"></i> 15 Domains</li>
                            </ul>
                        </div>
                    </div>
